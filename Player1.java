...
/**
 * Player1 class creates a player object, and this player has a name and team and is specifically meant to go first in the game
 *
 * Saul Varshavsky
...
public class Player1 
{
     ...
     */public Player1()
    {
        ...
        while( i < 21 )
        {
            displacement.add((int)(Math.random()*50+(i+2)));
            i++;
        }
        ...
        while( i < 21 )
        {
            launchVelocity.add((int)(Math.random()*50+(i+2)));
            i++;
        }
        ...
        while( i < 21 )
        {
            landVelocity.add((int)(Math.random()*50+(i+2)));
            i++;
        }
     ...
     */public String toString()
    {
        ...
        String information = "Player1 name: " + getPlayer() + "     Team name: " + getTeam() + "    These are the values you may be using depending on the question type: v0 = " + launchVelocity.get(l-1) + " vf = " + landVelocity.get(j-1) + " x = " + displacement.get(u-1) + " theta = " + angle.get(v-1);
        return information;
